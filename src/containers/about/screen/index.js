...
const AboutScreen = () => {
  return (
    <div className='data-container'>
      <h1>About</h1>
      <p>Hello, Dear friends, Welcome to Company also, we are happy you want to know something more about our site.</p>
      <p>
        So, basically, nowadays people are more dependent on online products and services that&apos;s why we also, take
        forward a step to help you.
      </p>
      <p>
        Our first wish is to provide you with a better solution to solve your problem. So, kindly if you don&apos;t get
        any solution then mention it in the comment section.
      </p>
      <p>
      ...
      <p>
        So, Our main goal is to provide you with 100% Original and Safe content that provides you a great and better
      ...
      <p>
        Basically, we focus on the Software Engineering niche so, our main priority is to search for new content and
        present it in front of you to learn something new.
      </p>
      ...
      <p>
        ...
        Engineering Category to help people.
      </p>
    </div>
  );
};
